...
# SOUND_SPEED_NXC = 19
# SOUND_SPEED_NZC = 31
SOUND_SPEED_X_MIN = -4e-3
SOUND_SPEED_X_MAX = 4e-3
SOUND_SPEED_Z_MIN = 5e-3
SOUND_SPEED_Z_MAX = 10e-3
SOUND_SPEED_NXC = 7
SOUND_SPEED_NZC = 7
...
NXP, NZP = 17, 17
PHASE_ERROR_X_MIN = -4e-3
PHASE_ERROR_X_MAX = 4e-3
PHASE_ERROR_Z_MIN = 5e-3
PHASE_ERROR_Z_MAX = 10e-3
...
def main(sample, loss_name):
    ...
    # xi = jnp.arange(BMODE_X_MIN, BMODE_X_MAX, 20)
    # zi = jnp.arange(BMODE_Z_MIN, BMODE_Z_MAX, 20)
    ...
    print(f"initial global c0 guess: {c0[np.argmin(dpe)]}")
...
if __name__ == "__main__":
    print(f"SAMPLE: {SAMPLE}, LOSS: {LOSS}")
    main(SAMPLE, LOSS)
